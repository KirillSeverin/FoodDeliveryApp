...
private extension OnboardingViewController {
    ...
    func setupButton() {
        ...
        bottomButton.addTarget(self, action: #selector(buttonPresed), for: .touchUpInside)
...
extension OnboardingViewController: UIPageViewControllerDelegate {
    func pageViewController(
        ...
        if let index = pages.firstIndex(
            of: pendingViewControllers.first! as! OnboardingPartViewController) {
